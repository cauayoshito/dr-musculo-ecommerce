...
async function main() {
  ...
  await Promise.all([
    prisma.user.upsert({
      where: { email: "salvador@drmusculo.com" },
      update: { storeId: storeSalvador.id, role: "STORE_OWNER" },
      create: {
        email: "salvador@drmusculo.com",
        name: "Gestor Salvador",
        hashedPassword: hashSync("loja123", 10),
        role: "STORE_OWNER",
        storeId: storeSalvador.id,
      },
    }),
    prisma.user.upsert({
      where: { email: "saj-a@drmusculo.com" },
      update: { storeId: storeSajA.id, role: "STORE_OWNER" },
      create: {
        email: "saj-a@drmusculo.com",
        name: "Gestor SAJ A",
        hashedPassword: hashSync("loja123", 10),
        role: "STORE_OWNER",
    ...
    prisma.user.upsert({
      where: { email: "saj-b@drmusculo.com" },
      update: { storeId: storeSajB.id, role: "STORE_OWNER" },
      create: {
        email: "saj-b@drmusculo.com",
        name: "Gestor SAJ B",
        hashedPassword: hashSync("loja123", 10),
        role: "STORE_OWNER",
